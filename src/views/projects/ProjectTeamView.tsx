...
export default function ProjectTeamView() {
  ...
  return (
    <>
      <h1 className="text-5xl font-black">Administrar Euqipo </h1>
      <p className="text-2xl font-light text-gray-500 mt-5">Administra en equipo de trabajo para este proyecto</p>
